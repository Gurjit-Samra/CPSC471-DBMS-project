...
CREATE TABLE `api_cart_includes` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `api_cart_includes_customer_email_content_t_2a68fa8c_uniq` (`customer_email`,`content_type_id`,`object_id`),
  KEY `api_cart_includes_content_type_id_4abd4a17_fk_django_co` (`content_type_id`),
...
--
-- Table structure for table `api_discountedproduct`
--

DROP TABLE IF EXISTS `api_discountedproduct`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `api_discountedproduct` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `api_discountedproduct_product_type_product_id__080695c0_uniq` (`product_type`,`product_id`,`admin_id`),
  KEY `api_discountedproduct_admin_id_d94367aa_fk_api_user_email` (`admin_id`),
  CONSTRAINT `api_discountedproduct_admin_id_d94367aa_fk_api_user_email` FOREIGN KEY (`admin_id`) REFERENCES `api_user` (`email`),
  CONSTRAINT `api_discountedproduct_chk_1` CHECK ((`product_id` >= 0))
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `api_discountedproduct`
--

LOCK TABLES `api_discountedproduct` WRITE;
/*!40000 ALTER TABLE `api_discountedproduct` DISABLE KEYS */;
INSERT INTO `api_discountedproduct` VALUES (1,'laptop',1,10.00,'faris1.salhi@gmail.com'),(3,'console',3,25.00,'faris1.salhi@gmail.com');
/*!40000 ALTER TABLE `api_discountedproduct` ENABLE KEYS */;
UNLOCK TABLES;
